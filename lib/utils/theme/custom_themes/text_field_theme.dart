...
class TTextFormFieldTheme {
  ...
  static InputDecorationTheme darkInputDecorationTheme = InputDecorationTheme(
    ...
    prefixIconColor: Colors.grey,
    suffixIconColor: Colors.grey,
    labelStyle: const TextStyle().copyWith(fontSize: TSizes.fontSizeMd, color: Colors.white),
    hintStyle: const TextStyle().copyWith(fontSize: TSizes.fontSizeSm, color: Colors.white),
