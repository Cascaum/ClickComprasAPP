...
import 'package:clickcompras/features/personalization/screens/address/widgets/single_address.dart';
...
class UserAddressScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: TAppBar(showBackArrow: true, title: Text('Endereço', style: Theme.of(context).textTheme.headlineSmall),),
